...
#------------------------
img = cv2.imread('photos/Sophie.jpg')
    ...
    if w > 130:  # ignore small faces
        ...
        try:
            ...
            cv2.rectangle(img, (x+int(w/2)-50, y-20),
                          (x+int(w/2)+50, y-90), info_box_color, cv2.FILLED)

            # labels for age and gender
            cv2.putText(img, apparent_age, (x+int(w/2), y - 45),
            ...
            if enableGenderIcons:
                ...
                cv2.putText(img, gender, (x+int(w/2)-42, y - 45),
                            cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 111, 255), 2)
